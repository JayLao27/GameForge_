...
<body>
    <div id="Color-home" class="container-fluid p-0">
        <div class="top-bar  py-2 d-none d-md-block"></div> 
            ...
            <div class="container">
                <div style="top: 50px; position: relative;" class="align-items-center">
                    ...
                    <div class="container justify-content-center gap-30" id="Card">
                        <ul>
                            <li><a class="Card-href" href="../../Resources/views/Product/Keyboard-web.php"> <div class="Card-Keyboard-Mouse-Laptop">
                                <img src="../../../Images/Shop/Keyboard.png" alt="Keyboard"><p>Keyboard</p></div></a></li> 

                            <li><a class="Card-href" href="../../Resources/views/Product/Mouse-web.php"> <div class="Card-Keyboard-Mouse-Laptop">
                                <img src="../../../Images/Shop/Mouse.png" alt="Mouse"><p>Mouse</p></div></a></li>

                            <li><a class="Card-href" href="../../Resources/views/Product/Laptop-web.php"> <div class="Card-Keyboard-Mouse-Laptop">
                                <img src="../../../Images/Shop/Laptop.png" alt="Laptop"><p>Laptop</p></div></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <a href="#" class="text-decoration-none text-dark">
                            <div class="product-card">
                                ...
                                <div class="product-info">
                                    <p class="fw-bold">HyperX Gaming Headset</p>
