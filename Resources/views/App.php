    ...
    <div class="container">
        <div style="top: 50px; position: relative;" class="align-items-center">
            ...
            <div class="container justify-content-center gap-30" id="Card">
                <ul>    
                    <li><div class="Card-Keyboard-Mouse-Laptop"><img src="../../Images/Shop/Keyboard.png" alt="Keyboard"><p>Keyboard</p></div></li>
                    <li><div class="Card-Keyboard-Mouse-Laptop"><img src="../../Images/Shop/Mouse.png" alt="Mouse"><p>Mouse</p></div></li>
                    <li><div class="Card-Keyboard-Mouse-Laptop"><img src="../../Images/Shop/Laptop.png" alt="Laptop"><p>Laptop</p></div></li>
                </ul>
            </div>
        </div>
    </div>
