...
<body class="bg-gray-200" data-cart='<?php echo $cart_json; ?>'>
    <div class="max-w-6xl mx-auto mt-20 mb-20 p-6 bg-white shadow-lg rounded-lg">
        ...
        <div class="flex justify-between items-center mt-6 bg-gray-100 p-4 rounded-lg">
            <div>
    ...
    <p class="text-xl font-bold text-yellow-600 mt-2">Total: <span id="totalPrice">₱0.00</span></p>
            ...
            <button onclick="checkout()" class="px-6 py-3 bg-blue-600 text-white text-lg font-semibold rounded-lg shadow-lg">CHECKOUT</button>
        </div>
    </div>
</body>
</html>
