<!--Footer-->
<footer class="bg-[#FBFF10] text-black font-poppins py-8">
    <div class="max-w-6xl mx-auto px-2 flex flex-col md:flex-row justify-between items-start">
        ...
        <!--links-->
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mt-6 md:mt-0 text-sm">
            <div>
            ...
            <div>
                <h3 class="font-bold text-blue-900">Other Offers</h3>
                <ul>
